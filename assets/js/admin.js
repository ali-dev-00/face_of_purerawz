jQuery(document).ready(function($) {
    ...
    // Handle action button clicks with AJAX
    $('.face-of-purerawz-action-button').on('click', function(e) {
        e.preventDefault();
        var $button = $(this);
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    $button.closest('tr').find('.face-of-purerawz-status-badge')
                    ...
                    $button.closest('tr').find('td:nth-child(8)').text(approvedAt);
